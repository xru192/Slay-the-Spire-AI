...
public abstract class AbstractGridAutoPlayer {
    public static final Logger logger = LogManager.getLogger(AbstractGridAutoPlayer.class.getName());
    ...
    protected static class CardPair {
        @NotNull
        final AbstractCard first;
        @NotNull
        final AbstractCard second;
